...
var Api = {
	...
	getSyncNotebooks: function(afterUsn, maxEntry, callback) {
		var me = this;
		var url = this.getUrl('notebook/getSyncNotebooks');
		// console.log(url);
		needle.post(url, {afterUsn: afterUsn, maxEntry: maxEntry}, 
	...
	getSyncNotes: function(afterUsn, maxEntry, callback) {
		var me = this;
		var url = this.getUrl('note/getSyncNotes');
		log(url);
		needle.post(url, {afterUsn: afterUsn, maxEntry: maxEntry}, function(error, response) {
			me.checkError(error, response);
			if(error) {
	...
	getSyncTags: function(afterUsn, maxEntry, callback) {
		var me = this;
		var url = this.getUrl('tag/getSyncTags');
		log(url);
		needle.post(url, {afterUsn: afterUsn, maxEntry: maxEntry}, function(error, response) {
			me.checkError(error, response);
			if(error) {
	...
	getLastSyncState: function(callback) {
		...
		// console.log(url);
		needle.post(url, {timeout: 10000}, function(error, response) {
	...
	getNoteContent: function(noteId, callback) {
		var me = this;
		var url = this.getUrl('note/getNoteContent');
		console.log('	get note content from server...', noteId);
		// console.log(url);
		needle.post(url, {noteId: noteId}, function(error, response) {
			me.checkError(error, response);
			if(error) {
				log(error);
				return callback && callback(false);
	...
	getImage: function(fileId, callback) {
		var me = this;
		var url = me.getUrl('file/getImage');

		// console.log('getImage');
		// console.log(url);

		needle.post(url, {fileId: fileId}, function(err, resp) {
	...
	getAttach: function(serverFileId, callback) {
		var me = this;
		var url = me.getUrl('file/getAttach');
		console.log(url);
		needle.post(url, {fileId: serverFileId}, function(err, resp) {
			me.checkError(err, resp);
			if(err) {
				return callback && callback(false);
			}
